...
namespace AutoTrade.Tests
{
	...
	public class DealerShopTests
	{
		...
		[Test]
		public void DealerSopShouldBeInstantiatedCorrectly()
		{
			int capacity = 5;
		...
		public void DealerSopShouldNotBeInstantiatedWithInvalidCapacity(int capacity)
		{
			Assert.Throws<ArgumentException>(() => new DealerShop(capacity));
		}

		[Test]
		public void VehicleShouldBeAddedSucsessfully()
		{
		...
		[Test]
		public void AddShouldThrowAnExeptionIfLimitIsReached()
		{
		...
		public void InventoryReportShouldWorkCorrectly()
		{
			...
			string expected = $"Inventory Report{Environment.NewLine}Capacity: 5{Environment.NewLine}Vehicles: 2{Environment.NewLine}2024 make1 model1{Environment.NewLine}2024 make2 model2";  
