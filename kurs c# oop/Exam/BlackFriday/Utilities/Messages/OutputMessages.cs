namespace BlackFriday.Utilities.Messages
{
    public static class OutputMessages
    {
        ...
        public const string ProductAdded = "{0}: {1} is added in the application. Price: {2:F2}";

        //UpdateProductPrice
        public const string ProductPriceUpdated = "{0} -> Price is updated: {1:F2} -> {2:F2}";
        ...
        public const string ProductPurchased = "{0} purchased {1}. Price: {2:F2}";
    }
}
